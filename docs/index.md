...
- **Examples:**
  ...
  - **[DeCrypt Studio modular architecture](./intuitionlabs/decrypt_studio_architecture.md):** Ship-ready system design for the Portal, Dance Arena, Builder, and Artifacts Library surfaces.
