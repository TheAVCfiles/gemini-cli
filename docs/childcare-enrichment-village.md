# Childcare + Enrichment Village Deliverables

This document consolidates strategic, fundraising, and operational collateral for the Childcare + Enrichment Village concept in Fairfield County (Westport / Wilton / Easton / Pound Ridge). All sections are formatted for direct reuse in decks, outreach, and low-code site builders.

**Origin & Dedication:** The foundational community vision for this initiative is credited to Sgt. Brandon N. Mohamed of New York, whose articulation of social and emotional development needs—and his Kingston, NY vacant mall reimagining—sparked this shared pursuit of greater public welfare and expanded social opportunity. In alignment with his vision, this document is dedicated to keeping the avenues of inspiration open so that contributors can access, adapt, and invest in every derivative, iteration, and collaborative pathway, celebrating each person as a vital pixel in the larger immersive imagination that brings these projects to life.

---

## One-Page Investment Memo

**Childcare + Enrichment Village — Fairfield County (Westport / Wilton / Easton / Pound Ridge)**

**Founder:** Allison Van Cura — choreographer, educator, systems designer. Pilot operator with local traction and a tech-enabled trust stack (digital-notary + “Sentient Cents” scholarship ledger).

**Opportunity (30s):**
Affluent towns with high parental labor-force participation face a severe shortage of licensed infant/toddler & integrated enrichment care. Real estate is expensive; staffing and regulation create frictions. We create a mission-owned campus (nonprofit owns land/buildings) with a for-profit operator running a licensed childcare village + dance studio + STEAM labs + farm that lowers family costs via bulk purchasing, volunteer crediting, and scholarship micro-ledgers.
...
**Uses of funds (ask):** **$1,250,000** (example target) — acquire & renovate 2–3 acre site + buildout + 12 months operating cushion + scholarship seed + sensors/tech. Scalable asks available ($350k pilot → $2.5M village).

**Use of Proceeds (example $1.25M):**

- Property deposit & acquisition: $700k
- Renovation & playground/farmscaping: $250k
- Licensing/building compliance & engineering: $60k
- Operating cushion (12 months): $160k
- Scholarship seed & Sentient Cents admin: $30k

**Financial snapshot (3yr):** Target breakeven 18–30 months; stabilized margins 18–28%; projected NOI grows with add-on programming and studio rentals. (Detailed pro-forma attached/available.)

**Impact metrics:** capacity 120 children; 15% scholarship slots year 1; measurable early-learning outcome score improvements; parental workforce participation gains.

**Risks & mitigants:** zoning pushback (community outreach + pre-apps), staffing shortages (apprentice pipeline + competitive pay & benefits), capex surprise (survey/Phase I required prior to close).

**Exit & Return (impact):** For impact investors: blended social ROI + steady cashflows; for property investors: long-term lease to operator; nonprofit stewardship mitigates mission drift.

**Next steps:** LOI + Option on site; seed close to fund surveys + permits. Contact: Allison Van Cura — [acfwrites@gmail.com](mailto:acfwrites@gmail.com) — (###) ###-####
...
- **Copy bullets:**
  ...
  - High real estate & staffing costs mean small operators, high price — limited access.
  - Families resort to expensive private care or job compromises (productivity loss for employers).
...
- **Copy bullets:**
  ...
  - Nonprofit owns property (grants & tax advantage) + for-profit operator runs programming.
  - Tech trust: notarized contracts + Sentient Cents scholarship ledger = transparent subsidies.
...
- **Copy bullets:**
  ...
  - Successful pilot aftercare/dance integration with Y% retention, Z revenue per child.
  - Local partnerships: school PTOs, studio managers, two CVs of staff leads.
...
- **Copy bullets:**
  ...
  - Unit economics: ARPU per child, CAC target, breakeven timeline (18–30 months).
  - Capital ask example packages: Pilot $250k, Acquisition $1.25M, Full Village $2.5M.
...
- **Copy bullets:**
  ...
  - Opportunities for funders: site ownership (nonprofit), program naming rights, scholarship match.
  - Immediate next step: commit to LOI + seed tranche to fund surveys & permits.
- **Speaker note:** “We have pilots and demand. We need a partner for land & capital to scale rapidly.” End with clear ask and contact.
...
Use personalization tokens such as [Name], [Org], [Property], and [Town]. Subject lines remain short.

1. **Impact Investor / Family Office**  
   **Subject:** Invest in scalable childcare + enrichment campus in Fairfield County  
   **Body:**  
   Hi [Name],  
   I’m Allison Van Cura. We’re building a licensed Childcare + Enrichment Village in the Westport corridor that pairs mission property ownership (nonprofit) with a revenue-generating operator. We have a pilot and a growing Founding Family list. We’re raising $[ask] for site acquisition & buildout. I’d love 20 minutes to share our 3-yr pro-forma and social KPIs. Are you free [date options]?  
   — Allison ([acfwrites@gmail.com](mailto:acfwrites@gmail.com))

2. **Local Foundation Officer**  
   **Subject:** Grant opportunity: childcare & scholarship campus for Fairfield County  
   Hi [Name],  
   I’m launching a licensed childcare village that includes a scholarship engine (Sentient Cents) to make access affordable. We’re seeking grant support for site acquisition / scholarship seed. Can I send a one-pager and 10-minute briefing this week?  
   — Allison

3. **Town Planner / Zoning Pre-app**  
   **Subject:** Pre-application request — childcare + arts/farm campus in [Town]  
   Hello [Planner],  
   I’d like a 30-minute pre-app to discuss zoning and permitting for a licensed childcare + dance/STEAM/farm campus. We have a pilot and properties we’re evaluating. When are you available?  
   — Allison

4. **Landlord / Church**  
   **Subject:** Activate underused property as a childcare + enrichment campus  
   Hi [Name],  
   We’re searching for a long-term partner (ground lease or LOI) to house a licensed childcare village that will revitalize property and return community services. Would you consider a 20-minute meeting to explore a partnership?  
   — Allison

5. **Probate / Estate Attorney**  
   **Subject:** Estate properties & mission buyer for community reuse  
   Hi [Name],  
   I work with nonprofits that purchase estate properties for community childcare / arts centers. If you have clients with small farms, barns, or houses that need a mission-minded buyer, could we speak? We move quickly with LOIs.  
   — Allison

6. **Commercial Broker**  
   **Subject:** Off-market search — farm/institutional property (Westport/Easton/Wilton)  
   Hi [Name],  
   Looking for 1–5 acre parcels, former schools, churches, or garden centers. We have deposit capital & a nonprofit buyer. Can you send off-market options? I’ll keep conversations confidential.  
   — Allison

7. **Church / Faith Leader**  
   **Subject:** Partnership: activate underused meeting space for childcare & community  
   Hi [Name],  
   Could we explore a ground lease/partnership? We offer community programming and scholarships in exchange for reasonable lease terms and shared space. I’d value 20 minutes to discuss mutual benefit.  
   — Allison

8. **Corporate HR / Employer (local companies)**  
   **Subject:** Employer childcare opportunity for your workforce  
   Hi [Name],  
   We’re launching a licensed childcare + enrichment campus and offering employer-sponsored slots. This reduces turnover and boosts productivity. Can we explore a pilot employer contract?  
   — Allison

9. **CDFI / Community Bank**  
   **Subject:** Mission lending inquiry — childcare campus financing  
   Hi [Name],  
   We’re raising a blended capital stack (SBA + mission debt + grants) to acquire property for a licensed childcare village. I’d like to share our pro-forma and explore CDFI bridge lending. Can we schedule 20 minutes?  
   — Allison

10. **PTO / School Leader**  
    **Subject:** Founding Families: help secure local childcare in [Town]  
    Hi [Name],  
    We’re building a childcare + enrichment village and inviting PTOs to partner on outreach — founding family deposits help secure a site. Could I present at your next meeting for 10 minutes?  
    — Allison

---

## Three-Minute Demo Script & Shot List

**Goal:** Demonstrate founder credibility, sense of place, technology-enabled trust, family benefits, and the ask within a three-minute emotional video.
...
## Daily Opportunity Sourcing & Alerts Playbook
...
- County probate and recorder/clerk docket searches (manual or RSS where available)
- Town planning agenda scraper (municipal websites)
- Nextdoor and Facebook neighborhood groups monitoring
- Grant portals: Fairfield County Community Foundation, CT OEC grant pages (RSS or weekly check)
...
- **Google Alerts:**
  ...
  - "former nursery" OR "garden center" Westport OR Wilton
  - "church for lease" Westport OR Wilton
  - "school building for sale" Westport OR Wilton
  - "tax sale" "Fairfield County"
  - "child care" "Westport" waitlist
- **LoopNet / CoStar / MLS Filters:**
  - Property Type: Institutional, Retail, Land
  - Size: 1–5 acres; buildings 2,000–12,000 square feet
  - Keywords: “church”, “school”, “daycare”, “barn”, “nursery”, “garden center”
  - Geography: Westport, Wilton, Easton, Pound Ridge, Scarsdale corridor
  - Save searches and enable daily email alerts
- **County / Probate:**
  - Check Fairfield County Probate Court dockets for estates (keywords “estate,” “petition for probate,” “administration”). When no RSS exists, engage clerk or title firm for feeds.
- **Town Planning / Zoning:**
  - Subscribe to planning commission agendas for Westport, Wilton, Easton, Pound Ridge. Scan for “special permit,” “change of use,” “site plan,” “institutional.”
- **Local Social Feeds:**
  - Monitor Nextdoor groups for “estate sale,” “church closing,” “land for lease.”
...
- **Budget:** $25k–$75k, covering:
  - Lease deposit & 3–6 months rent: $6k–$20k
  - Licensing & legal: $1k–$5k
  - Staffing (director + two teachers, three months): $15k–$30k
  - Insurance, marketing, equipment: $3k–$10k
...
- Share services such as meals and administration across programs.
- Fund small capital needs with founding family deposits and community grants.

---

## From “Here → Ribbon” Checklist
...
## Ready-to-Produce Assets

- PDF-ready one-pager and five-slide deck (export from this content).
- Webflow/Squarespace-ready copy blocks with CTA and Stripe integration callouts.
- Airtable templates for opportunity pipeline, Founders deposits, and Sentient Cents ledger.
- Zapier recipe: Google Alerts / LoopNet → Airtable digest → daily email summary.
- Property LOI template with due diligence contingencies and municipal pre-app clause.
- CT OEC pre-licensing checklist plus town-specific pre-app language (consult counsel for final wording).

---

**Next Actions:** Confirm priority assets (PDF deck, landing page block, automation templates) and begin formatting or automation build-out as needed.
