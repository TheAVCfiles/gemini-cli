import {
  ...
  jsx,
  jsxs,
} from 'https://esm.sh/react@18.3.1?dev/jsx-runtime';
import React, {
  useState,
  useEffect,
  useCallback,
...
const App = () => {
  ...
  const ActionButton = ({ action }) =>
    /* @__PURE__ */ jsxs('button', {
      ...
      children: [
        /* @__PURE__ */ jsx('div', {
          className: 'text-3xl sm:text-4xl mb-1 drop-shadow-md',
      ...
      children: [
        /* @__PURE__ */ jsxs('div', {
          children: [
            ...
            /* @__PURE__ */ jsx('h3', {
              className:
                'font-extrabold mb-2 text-sm sm:text-base text-gray-100',
              children: item.name,
            }),
          ],
        }),
        /* @__PURE__ */ jsx('div', {
          ...
          children: isInInventory
            ...
            : /* @__PURE__ */ jsx('button', {
                ...
                children:
                  coins >= item.cost
                    ? `Buy \u{1F4B0} ${item.cost}`
                    : `\u{1F4B0} ${item.cost} (LOCKED)`,
              }),
        }),
      ],
    });
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    style: {
      backgroundImage: 'radial-gradient(at 50% 100%, #150030 0%, #000000 70%)',
    },
    children: [
      /* @__PURE__ */ jsx('div', {
        ...
        children: /* @__PURE__ */ jsx('div', {
          className:
            'bg-black/70 rounded-xl p-3 backdrop-blur border-2 border-gray-700 shadow-2xl shadow-fuchsia-900/30',
          children: /* @__PURE__ */ jsxs('div', {
            className:
              'flex justify-around items-center flex-wrap text-sm sm:text-base gap-2 tracking-wide',
            children: [
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsx(Zap, {
                    className:
                      'text-cyan-400 w-5 h-5 drop-shadow-[0_0_5px_cyan]',
                  }),
                  /* @__PURE__ */ jsxs('span', {
              ...
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsx(Star, {
                    className:
                      'text-yellow-400 w-5 h-5 drop-shadow-[0_0_5px_yellow]',
                  }),
                  /* @__PURE__ */ jsxs('span', {
      ...
      !showShop
        ? /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              /* @__PURE__ */ jsxs('div', {
                className:
                  'bg-gradient-to-b from-gray-900 to-black rounded-3xl p-6 sm:p-8 shadow-[0_0_40px_rgba(255,0,100,0.5)] border-4 border-fuchsia-500',
                children: [
                  /* @__PURE__ */ jsx('h1', {
                    className:
                      'text-2xl sm:text-4xl font-black text-center mb-6 text-fuchsia-300 tracking-widest drop-shadow-[0_0_10px_rgba(255,0,100,0.8)]',
                    children: '// CORE STAGE //',
                  }),
                  /* @__PURE__ */ jsx('div', {
                    className: 'text-center mb-4 min-h-[40px]',
                    children:
                      equippedItem &&
                      /* @__PURE__ */ jsxs('div', {
                        className:
                          'inline-flex items-center bg-black/60 p-2 rounded-full border border-cyan-400 shadow-lg shadow-cyan-900/50',
                        children: [
                          /* @__PURE__ */ jsx(Sparkles, {
                            className:
                              'w-4 h-4 text-cyan-300 mr-1 animate-spin',
                            style: { animationDuration: '2s' },
                          }),
                          /* @__PURE__ */ jsx('span', {
                            className:
                              'text-xs font-semibold text-gray-300 mr-2',
                            children: 'STATUS EFFECT:',
                          }),
                          /* @__PURE__ */ jsxs('span', {
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    className:
                      'bg-black/70 rounded-2xl p-6 sm:p-8 mb-6 min-h-[250px] flex flex-col justify-center items-center relative overflow-hidden border-2 border-gray-700 shadow-inner shadow-fuchsia-900/50',
                    children: [
                      isPlaying &&
                        moveStartTime > 0 &&
                        /* @__PURE__ */ jsx('div', {
                          className:
                            'absolute top-0 left-0 h-2 bg-gradient-to-r from-red-600 to-yellow-400',
                          style: {
                      ...
                      /* @__PURE__ */ jsx('div', {
                        className:
                          'text-6xl sm:text-8xl mb-4 text-cyan-400 drop-shadow-[0_0_10px_cyan] animate-pulse',
                        children: currentMove.action.icon,
                      }),
                      /* @__PURE__ */ jsx('h2', {
                        className:
                          'text-2xl sm:text-3xl font-black mb-2 text-center text-red-400 tracking-widest drop-shadow-[0_0_5px_red]',
                        children: currentMove.name,
                      }),
                      /* @__PURE__ */ jsx('p', {
                        className:
                          'text-base sm:text-lg text-center mb-4 text-gray-300 italic',
                        children: currentMove.description,
                      }),
                      /* @__PURE__ */ jsx('div', {
                        className:
                          'bg-fuchsia-800 px-4 py-2 rounded-full shadow-lg shadow-fuchsia-900/50 border border-fuchsia-400',
                  ...
                  /* @__PURE__ */ jsx('div', {
                    ...
                    children: Object.values(ACTIONS).map((action) =>
                      /* @__PURE__ */ jsx(
                        ActionButton,
                        { action },
                        action.name,
                  ...
                  /* @__PURE__ */ jsx('div', {
                    ...
                    children: /* @__PURE__ */ jsxs('button', {
                      ...
                      className:
                        'bg-gradient-to-r from-green-500 to-lime-600 hover:from-green-600 hover:to-lime-700 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-black text-lg sm:text-xl flex items-center gap-3 shadow-lime-900/50 shadow-lg transform hover:scale-[1.02] active:scale-95 transition-all duration-150 border-2 border-lime-300',
                      style: { textShadow: '0 0 5px #a7f3d0' },
                      children: [
                        isPlaying
                          ? /* @__PURE__ */ jsx(Pause, { size: 28 })
                      ...
                      /* @__PURE__ */ jsx('p', {
                        ...
                        children: isPlaying
                          ? combo > 15
                            ? /* @__PURE__ */ jsx('span', {
                                className:
                                  'text-yellow-400 drop-shadow-[0_0_8px_yellow] font-bold',
                                children: 'UNSTOPPABLE! PUSH THE LIMITS!',
                              })
                            : combo > 5
                              ? /* @__PURE__ */ jsx('span', {
                                  className: 'text-red-400 font-bold',
                                  children: 'RISING HEAT! MAINTAIN THE CHAIN!',
                                })
              ...
              /* @__PURE__ */ jsx('div', {
                ...
                children: /* @__PURE__ */ jsxs('button', {
                  ...
                  className:
                    'bg-black/80 hover:bg-black/90 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-black text-lg sm:text-xl flex items-center gap-3 shadow-fuchsia-500/50 shadow-[0_0_20px_rgba(217,70,239,0.7)] transform hover:scale-[1.02] active:scale-95 transition mx-auto border-2 border-fuchsia-500 text-fuchsia-300',
                  children: [
        ...
        : /* @__PURE__ */ jsx('div', {
            ...
            children: /* @__PURE__ */ jsxs('div', {
              className:
                'bg-gradient-to-b from-gray-900 to-black rounded-3xl p-6 sm:p-8 shadow-[0_0_40px_rgba(52,211,235,0.5)] border-4 border-cyan-500',
              children: [
                /* @__PURE__ */ jsx('h1', {
                  className:
                    'text-3xl sm:text-4xl font-black text-center mb-6 text-cyan-300 tracking-widest drop-shadow-[0_0_10px_rgba(52,211,235,0.8)]',
                  children: '// GLAM SHOP & INVENTORY //',
                }),
                /* @__PURE__ */ jsx('p', {
                ...
                /* @__PURE__ */ jsx('div', {
                  ...
                  children: SHOP_ITEMS.map((item) =>
                    /* @__PURE__ */ jsx(ShopItemCard, { item }, item.id),
                  ),
                }),
                /* @__PURE__ */ jsx('div', {
                  className: 'text-center mt-6',
                  children: /* @__PURE__ */ jsx('button', {
                    ...
                    className:
                      'bg-black/80 hover:bg-black/90 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-black text-lg sm:text-xl shadow-cyan-500/50 shadow-[0_0_20px_rgba(52,211,235,0.7)] transform hover:scale-[1.02] active:scale-95 transition mx-auto border-2 border-cyan-500 text-cyan-300',
