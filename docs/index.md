...
- **Examples:**
  ...
  - **[Sovereignty Console React widget](./examples/sovereignty-console.md):** Drop-in UI that multiplies control, clarity, and continuum inputs into a single stability score.
