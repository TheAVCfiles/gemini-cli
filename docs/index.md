...
- **Examples:**
  ...
  - **[Lithium market time-series analysis](./examples/lithium-market-analysis.md):** Walkthrough for streaming a commodities-and-crypto CSV into Gemini CLI and extracting insights.
