...
- `Anaretic_Checklist.md` — Daily/weekly Guardian protocol reference.
- `README-Plug-Founding-Time.md` — Operational instructions for finalizing astro runs.
- `Founding-Datetime-Template.md` — YAML + RAG workflow for capturing founding moment data.
- `Founding-Moment-Interpretation-template.md` — Narrative interpretation template for the founding chart.
- `29_protocol_engine.py` — Placeholder astro engine script with deterministic sample data.
