...
export default function StageCrest({ state = 'inactive', size = 140, className = '', ariaLabel = 'StagePort Crest' }) {
  ...
  return (
    <div
      ...
      aria-pressed={normalizedState === 'active' || normalizedState === 'notarized'}
